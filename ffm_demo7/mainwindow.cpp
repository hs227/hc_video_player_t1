...
void MainWindow::PlayV()
{
    ...
    if(ui->vnormalBtn->isChecked()){
        input.type_360_f=(unsigned int)VIDEO_TYPE::VT_SIMPLE;
    }else if(ui->v360Btn->isChecked()){
        input.type_360_f=(unsigned int)VIDEO_TYPE::VT_360;
    }else if(ui->v360RBtn->isChecked()){
        input.type_360_f=(unsigned int)VIDEO_TYPE::VT_360_R;
    }else{
        exit(EXIT_FAILURE);
    }
...
void MainWindow::keyPressEvent(QKeyEvent *event)
{
    ...
    case Qt::Key_W:
        //360:上
        videoCxtManager.k_360_in('w');
        break;
    case Qt::Key_S:
        //360:下
        videoCxtManager.k_360_in('s');
        break;
    case Qt::Key_A:
        //360:左
        videoCxtManager.k_360_in('a');
        break;
    case Qt::Key_D:
        //360:右
        videoCxtManager.k_360_in('d');
        break;
    case Qt::Key_F:
        //360:前进
        videoCxtManager.k_360_in('f');
        break;
    case Qt::Key_G:
        //360:后退
        videoCxtManager.k_360_in('g');
        break;
    case Qt::Key_P:
        //360:复位
        videoCxtManager.k_360_in('p');
        break;
    case Qt::Key_Q:
        //360:抬头
        videoCxtManager.k_360_in('q');
        break;
    case Qt::Key_E:
        //360:低头
        videoCxtManager.k_360_in('e');
        break;
    case Qt::Key_Z:
        //360:左转
        videoCxtManager.k_360_in('z');
        break;
    case Qt::Key_C:
        //360:右转
        videoCxtManager.k_360_in('c');
        break;
    default:
        break;
    }
